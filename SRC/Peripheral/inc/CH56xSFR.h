...
#define R8_SPI_ROM_CTRL         (*((PUINT8V)0x40001018))
...
#define R32_EMMC_STATUS         (*((PUINT32V)(0x4000A020))) // SD status:[15:0] number of current successful tran/recv blocks, [16] current sd cmd line level, [17] current sd dat[0] line level
